...
java -Xms1G -Xmx4G -Dserver.port=8081 -jar /app/auth-service.jar > /app/auth.log 2>&1 &

# 2. Avvia Expense Service in background
echo "--> Avvio Expense Service (Porta 8084)..."
java -Xms1G -Xmx4G -Dserver.port=8084 -jar /app/expense-service.jar > /app/expense.log 2>&1 &
...
java -Xms1G -Xmx4G -Dserver.port=7860 -jar /app/gateway-service.jar