  ...
  return (
    <div className="page-container">
      ...
      <div className="card" style={{ marginBottom: '1.5rem' }}>
        ...
        >
          <div className="input-group">
            <label className="input-label">Mostra spese</label>
            <select
              className="input-field"
              value={mode}
          ...
          {mode === 'range' && (
            <>
              <div className="input-group">
                <label className="input-label">Data inizio</label>
                <input
                  type="date"
                  className="input-field"
              ...
              <div className="input-group">
                <label className="input-label">Data fine</label>
                <input
                  type="date"
                  className="input-field"
        ...
        {activeFilterDescription && (
          <p style={{ margin: '1rem 0 0', color: 'var(--primary-600)', fontWeight: 600 }}>
            {activeFilterDescription}
          </p>
        )}
      </div>
      ...
      {loading ? (
        <div className="card" style={{ textAlign: 'center' }}>
          <p style={{ color: 'var(--text-muted)' }}>Caricamento dei tuoi dati finanziari…</p>
        </div>
      ) : (
        <>
